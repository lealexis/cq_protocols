...
def main(plot_params):
    ...
    for z in range(len(noise_param)):
        ...
        for _ in range(num_trials):
            ...
            for qubit in FRAMES[0]:
                depolarizing_channel.depolarizing_channel(qubit, noise_param[z])
            ...
            "XOR between input and received message."
    ...
    plot.xlabel("Depolarizing probability (p)")
