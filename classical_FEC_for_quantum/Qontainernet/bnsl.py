...
def test_topo(seq, rounds, epr_num, packet_num, epr_frame_size, net):
    """Run test topology"""
    ...
    h_1.cmd(
        f"tmux new-session -d -s h1 'python traffic_generation.py 11.0.0.2 {rounds} {epr_num} {packet_num} {packet_size}'")
...
if __name__ == "__main__":
    ...
    for setting in settings:
        ...
        try:
            ...
            test_topo(seq, rounds, epr_num, packet_num, epr_frame_size, net)
